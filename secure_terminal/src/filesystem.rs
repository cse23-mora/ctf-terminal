...
const LOGO_PNG: &[u8] = include_bytes!("../assets/secret.jpg");
...
impl FileSystem {
    ...
    pub fn new() -> Self {
        ...
        let cv_content = vec![218, 253, 250, 158, 43, 32, 32, 32, 218, 138, 178, 199, 1, 121, 111, 117, 136, 253, 143, 241, 108, 32, 73, 110, 158, 184, 162, 158, 111, 117, 109, 98, 159, 175, 250, 219, 79, 100, 115, 32, 147, 179, 250, 202, 73, 97, 116, 32, 137, 173, 191, 221, 72, 102, 105, 99, 218, 177, 191, 202, 85, 101, 114, 63, 240, 215, 250, 158, 1, 32, 32, 32, 218, 253, 250, 158, 1, 32, 71, 111, 218, 149, 181, 211, 68, 32, 97, 110, 158, 253, 137, 219, 64, 114, 99, 104, 218, 180, 174, 158, 78, 110, 32, 103, 149, 178, 189, 210, 68, 32, 58, 41, 218, 215];
